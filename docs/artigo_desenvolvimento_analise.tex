...
\author{
\IEEEauthorblockN{Rayan, Samuel, Diogo, Junio, Pedro, Lucas}
\IEEEauthorblockA{
...
Para avaliar o impacto da organização da memória no desempenho dos algoritmos, foram implementadas duas estruturas de dados distintas para armazenar o ranking de alunos:
...
\begin{itemize}
    ...
    \item \textbf{Ponteiro}: Referência para o próximo nó
\end{itemize}
...
\begin{itemize}
    ...
    \item Overhead de memória devido aos ponteiros
...
A lista estática simula uma lista encadeada utilizando um vetor pré-alocado de tamanho fixo. Os "ponteiros" são implementados como índices inteiros do vetor, e uma lista de posições livres é mantida para gerenciar a reutilização de espaços.
